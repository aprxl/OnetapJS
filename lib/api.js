...
class OnetapAPI {
    ...
    HandleErrors( data ) {
        ...
        try {
            ...
            throw new Error("[ONETAP] Unable to parse data. (Wrong API keys?)");
        }
        ...
        switch( obj.errors[0].code ) {
            case "endpoint_not_found":
                throw new Error("[ONETAP] [API] Invalid endpoint.");

            case "invalid_request_header_content_type":
                throw new Error("[ONETAP] [API] Invalid header content type.");

            case "requested_user_not_found":
                throw new Error("[ONETAP] [API] The requested user could not be found.");

            case "requested_config_not_found":
                throw new Error("[ONETAP] [API] The requested configuration could not be found.");

            case "requested_script_not_found":
                throw new Error("[ONETAP] [API] The requested script could not be found.");

            case "requested_script_not_found":
                throw new Error("[ONETAP] [API] The requested script could not be found.");

            case "config_name_cannot_be_empty":
                throw new Error("[ONETAP] [API] The configuration's name cannot be empty.");

            case "config_name_exceeds_max_length":
                throw new Error("[ONETAP] [API] The configuration's name is too big.");

            case "config_name_only_alphanumeric_underscore":
                throw new Error("[ONETAP] [API] The configuration's name has invalid characters.");

            case "config_data_cannot_be_empty":
                throw new Error("[ONETAP] [API] The configurations's data cannot be empty.");

            case "config_data_contains_unexpected_contents":
                throw new Error("[ONETAP] [API] The configuration's data has invalid contents.");

            case "script_name_cannot_be_empty":
                throw new Error("[ONETAP] [API] The scripts's name cannot be empty.");

            case "script_name_exceeds_max_length":
                throw new Error("[ONETAP] [API] The scripts's name is too big.");

            case "script_name_only_alphanumeric_underscore":
                throw new Error("[ONETAP] [API] The scripts's name has invalid characters.");

            case "script_data_cannot_be_empty":
                throw new Error("[ONETAP] [API] The scripts's data cannot be empty.");

            case "script_data_contains_unexpected_contents":
                throw new Error("[ONETAP] [API] The scripts's data has invalid contents.");

            case "config_subscription_already_exists":
                throw new Error("[ONETAP] [API] This user already has the specified configuration.");

            case "requested_config_subscription_not_found":
                throw new Error("[ONETAP] [API] This configuration's subscriptions could not be found.");

            case "script_subscription_already_exists":
                throw new Error("[ONETAP] [API] This user already has the specified script.");

            case "requested_script_subscription_not_found":
                throw new Error("[ONETAP] [API] This script's subscriptions could not be found.");

            default:
                throw new Error("[ONETAP] [API] Unexpected error occured.")
        }
    }
