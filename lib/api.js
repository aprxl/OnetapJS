...
class OnetapAPI {
    ...
    HandleErrors( data ) {
        ...
        switch( obj.errors[0].code ) {
            case "endpoint_not_found":
                return console.log("[ONETAP] [API] Invalid endpoint.");

            case "invalid_request_header_content_type":
                return console.log("[ONETAP] [API] Invalid header content type.");

            case "requested_user_not_found":
                return console.log("[ONETAP] [API] The requested user could not be found.");

            case "requested_config_not_found":
                return console.log("[ONETAP] [API] The requested configuration could not be found.");

            case "requested_script_not_found":
                return console.log("[ONETAP] [API] The requested script could not be found.");

            case "requested_script_not_found":
                return console.log("[ONETAP] [API] The requested script could not be found.");

            case "config_name_cannot_be_empty":
                return console.log("[ONETAP] [API] The configuration's name cannot be empty.");

            case "config_name_exceeds_max_length":
                return console.log("[ONETAP] [API] The configuration's name is too big.");

            case "config_name_only_alphanumeric_underscore":
                return console.log("[ONETAP] [API] The configuration's name has invalid characters.");

            case "config_data_cannot_be_empty":
                return console.log("[ONETAP] [API] The configurations's data cannot be empty.");

            case "config_data_contains_unexpected_contents":
                return console.log("[ONETAP] [API] The configuration's data has invalid contents.");

            case "script_name_cannot_be_empty":
                return console.log("[ONETAP] [API] The scripts's name cannot be empty.");

            case "script_name_exceeds_max_length":
                return console.log("[ONETAP] [API] The scripts's name is too big.");

            case "script_name_only_alphanumeric_underscore":
                return console.log("[ONETAP] [API] The scripts's name has invalid characters.");

            case "script_data_cannot_be_empty":
                return console.log("[ONETAP] [API] The scripts's data cannot be empty.");

            case "script_data_contains_unexpected_contents":
                return console.log("[ONETAP] [API] The scripts's data has invalid contents.");

            case "config_subscription_already_exists":
                return console.log("[ONETAP] [API] This user already has the specified configuration.");

            case "requested_config_subscription_not_found":
                return console.log("[ONETAP] [API] This configuration's subscriptions could not be found.");

            case "script_subscription_already_exists":
                return console.log("[ONETAP] [API] This user already has the specified script.");

            case "requested_script_subscription_not_found":
                return console.log("[ONETAP] [API] This script's subscriptions could not be found.");

            default:
                return console.log("[ONETAP] [API] Unexpected error occured.")
        }
    }
    ...
    async GetConfigByName( callback, name ) {
        ...
        https.request(options, (res) => {
            ...
            res.on("end", () => {
                ...
                if (!config) 
                    return console.log(`[ONETAP] Couldn't find a configuration called ${name}.`);
    ...
    async GetConfigSubscriptionsByName( callback, name ) {
        ...
        this.GetConfigSubscriptions((list) => {
            if ( !list[name] )
                return console.log("[ONETAP] There are no subscriptions for this configuration.");
    ...
    async DeleteConfigSubscriptionByName( callback, name, user_id ) {
        ...
        this.GetConfigSubscriptionsByName((list) => {
            ...
            if ( !user_has_item )
                return console.log( "[ONETAP] This user doesn't have the specified item." );
    ...
    async GetScriptSubscriptionsByName( callback, name ) {
        ...
        this.GetScriptSubscriptions((list) => {
            if ( !list[name] )
                return console.log("[ONETAP] There are no subscriptions for this script.");
    ...
    async GetScriptByName( callback, name ) {
        ...
        https.request(options, (res) => {
            ...
            res.on("end", () => {
                ...
                if (!script) 
                    return console.log(`[ONETAP] Couldn't find a script called ${name}.`);
