...
class OnetapAPI {
    ...
    async GetConfigs( callback ) {
        ...
        const options = this.GenerateOptions( METHOD.GET, "/api/cloud/configs/" );
    ...
    async GetConfig( callback, id ) {
        ...
        const options = this.GenerateOptions( METHOD.GET, `/api/cloud/configs/${id}/` );
    ...
    async UpdateConfig( callback, id, name, data ) {
        ...
        const options = this.GenerateOptions(METHOD.POST, `/api/cloud/configs/${id}`, q);
    ...
    async AddConfig( callback, name, data ) {
        ...
        const options = this.GenerateOptions(METHOD.POST, "/api/cloud/configs/", q);
    ...
    async DeleteConfig( callback, id ) {
        ...
        const options = this.GenerateOptions(METHOD.DELETE, `/api/cloud/configs/${id}`);
    ...
    async GetConfigInvites( callback ) {
        ...
        const options = this.GenerateOptions( METHOD.GET, `/api/cloud/configs/invites/` );
    ...
    async GetConfigInvitesByID( callback, config_id ) {
        ...
        const options = this.GenerateOptions( METHOD.GET, `/api/cloud/configs/${config_id}/invites/` );
    ...
    async GetConfigSubscriptionsByID( callback, config_id ) {
        if ( !this.IsSetup( ) )
            ...
            const options = this.GenerateOptions( METHOD.GET, `/api/cloud/configs/${config_id}/subscriptions/` );
    ...
    async AddConfigSubscription( callback, config_id, user_id )
    {
        ...
        const options = this.GenerateOptions( METHOD.POST, `/api/cloud/configs/${config_id}/subscriptions`, q );
    ...
    async CreateConfigInvite( callback, config_id, max_age, max_uses ) {
        ...
        const options = this.GenerateOptions( METHOD.POST, `/api/cloud/configs/${config_id}/invites/`, q );
    ...
    async DeleteConfigSubscription( callback, config_id, user_id )
    {
        ...
        const options = this.GenerateOptions( METHOD.DELETE_PARAM, `/api/cloud/configs/${config_id}/subscriptions/`, q);
    ...
    async DeleteConfigInvite( callback, config_id, invite_id )
    {
        ...
        const options = this.GenerateOptions( METHOD.DELETE_PARAM, `/api/cloud/configs/${config_id}/invites/`, q);
    ...
    async GetScripts( callback ) {
        ...
        const options = this.GenerateOptions( METHOD.GET, "/api/cloud/scripts/" );
    ...
    async GetScript( callback, id ) {
        ...
        const options = this.GenerateOptions( METHOD.GET, `/api/cloud/scripts/${id}/` );
    ...
    async GetScriptInvites( callback ) {
        ...
        const options = this.GenerateOptions( METHOD.GET, `/api/cloud/scripts/invites/` );
    ...
    async GetScriptInvitesByID( callback, script_id ) {
        ...
        const options = this.GenerateOptions( METHOD.GET, `/api/cloud/scripts/${script_id}/invites/` );
    ...
    async GetScriptSubscriptionsByID( callback, script_id ) {
        ...
        const options = this.GenerateOptions( METHOD.GET, `/api/cloud/scripts/${script_id}/subscriptions/` );
    ...
    async AddScriptSubscription( callback, script_id, user_id )
    {
        ...
        const options = this.GenerateOptions( METHOD.POST, `/api/cloud/scripts/${script_id}/subscriptions`, q );
    ...
    async CreateScriptInvite( callback, script_id, max_age, max_uses ) {
        ...
        const options = this.GenerateOptions( METHOD.POST, `/api/cloud/scripts/${script_id}/invites/`, q );
    ...
    async DeleteScriptSubscription( callback, script_id, user_id )
    {
        ...
        const options = this.GenerateOptions( METHOD.DELETE_PARAM, `/api/cloud/scripts/${script_id}/subscriptions/`, q);
    ...
    async DeleteScriptInvite( callback, script_id, invite_id )
    {
        ...
        const options = this.GenerateOptions( METHOD.DELETE_PARAM, `/api/cloud/scripts/${script_id}/invites/`, q);
    ...
    async UpdateScript( callback, id, name ) {
        ...
        const options = this.GenerateOptions(METHOD.POST, `/api/cloud/scripts/${id}`, q);
    ...
    async DeleteScript( callback, id ) {
        ...
        const options = this.GenerateOptions(METHOD.DELETE, `/api/cloud/scripts/${id}`);
