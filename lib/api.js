...
class OnetapAPI {
    ...
    async DeleteConfigSubscription( callback, config_id, user_id )
    {
        ...
        const options = this.GenerateOptions( METHOD.DELETE, `/api/configs/${config_id}/subscriptions/`, q);
    ...
    async DeleteScriptSubscription( callback, script_id, user_id )
    {
        ...
        const options = this.GenerateOptions( METHOD.DELETE, `/api/scripts/${script_id}/subscriptions/`, q);
